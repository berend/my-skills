...
Ask the user for the PRD file (or PATH).

If the PRD is not already in your context window, read it from the project's .plans/PRDs folder.
...
### 5. Create the issue markdown files

For each approved slice, create a markdown file in the project's `.plans/ISSUES` folder. Use the issue body template below.
